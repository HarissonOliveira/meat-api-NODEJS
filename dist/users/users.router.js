...
class UsersRouter extends model_router_1.ModelRouter {
    ...
    applyRoutes(application) {
        application.get({ path: `${this.basePath}`, version: '2.0.0' }, [authz_handler_1.authorize('admin'), this.findByEmail, this.findAll]); // Exemplo de versionamento de rotas
        application.get({ path: `${this.basePath}`, version: '1.0.0' }, [authz_handler_1.authorize('admin'), this.findAll]); // Exemplo de versionamento de rotas
